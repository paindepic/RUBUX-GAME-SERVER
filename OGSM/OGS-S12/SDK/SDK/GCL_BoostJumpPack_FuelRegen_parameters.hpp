...
static_assert(offsetof(GCL_BoostJumpPack_FuelRegen_C_ResetBlink, PlayerPawn_0) == 0x000000, "Member 'GCL_BoostJumpPack_FuelRegen_C_ResetBlink::PlayerPawn_0' has a wrong offset!");
