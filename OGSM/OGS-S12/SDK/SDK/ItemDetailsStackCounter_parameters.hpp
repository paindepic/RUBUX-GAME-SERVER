...
static_assert(offsetof(ItemDetailsStackCounter_C_Refresh_Visibility, Temp_byte_Variable_1) == 0x000002, "Member 'ItemDetailsStackCounter_C_Refresh_Visibility::Temp_byte_Variable_1' has a wrong offset!");
...
static_assert(sizeof(ItemDetailsStackCounter_C_Update_Stack_Count) == 0x000078, "Wrong size on ItemDetailsStackCounter_C_Update_Stack_Count");
...
static_assert(offsetof(ItemDetailsStackCounter_C_Update_Stack_Count, K2Node_DynamicCast_AsFort_World_Item) == 0x000060, "Member 'ItemDetailsStackCounter_C_Update_Stack_Count::K2Node_DynamicCast_AsFort_World_Item' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_Update_Stack_Count, K2Node_DynamicCast_bSuccess) == 0x000068, "Member 'ItemDetailsStackCounter_C_Update_Stack_Count::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_Update_Stack_Count, CallFunc_GetFuelChargeValue_ReturnValue) == 0x00006C, "Member 'ItemDetailsStackCounter_C_Update_Stack_Count::CallFunc_GetFuelChargeValue_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemDetailsStackCounter_C_Update_Stack_Count, CallFunc_Greater_IntInt_ReturnValue) == 0x000070, "Member 'ItemDetailsStackCounter_C_Update_Stack_Count::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, CallFunc_IsValid_ReturnValue_1) == 0x000019, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
