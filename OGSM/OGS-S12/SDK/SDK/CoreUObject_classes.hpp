...
public:
	...
	static class UObject* FindObjectContainImp(const std::string& FullName, EClassCastFlags RequiredType = EClassCastFlags::None);
...
public:
	...
	template<typename UEType = UObject>
	static UEType* FindObjectContain(const std::string& Name, EClassCastFlags RequiredType = EClassCastFlags::None)
	{
		return static_cast<UEType*>(FindObjectContainImp(Name, RequiredType));
	}
