...
void AS12BP_MusicController_C::GetTracksForRegistration(TArray<class UBP_TimeSynthTrackComponent_C*>* Tracks)
{
	static class UFunction* Func = nullptr;
	...
	Params::S12BP_MusicController_C_GetTracksForRegistration Parms{};
