...
#include "CCPM_M_CatBurglar_FX_classes.hpp"
#include "CCPM_M_CatBurglar_FX_parameters.hpp"
...
void ACCPM_M_CatBurglar_FX_C::ExecuteUbergraph_CCPM_M_CatBurglar_FX(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "ExecuteUbergraph_CCPM_M_CatBurglar_FX");

	Params::CCPM_M_CatBurglar_FX_C_ExecuteUbergraph_CCPM_M_CatBurglar_FX Parms{};
...
void ACCPM_M_CatBurglar_FX_C::InitializeVariabels()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "InitializeVariabels");
...
void ACCPM_M_CatBurglar_FX_C::OnPostResIn()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "OnPostResIn");
...
void ACCPM_M_CatBurglar_FX_C::ResetSafetyGate()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "ResetSafetyGate");
...
void ACCPM_M_CatBurglar_FX_C::HackyWorkaroundRefreshTimerGuy()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "HackyWorkaroundRefreshTimerGuy");
...
void ACCPM_M_CatBurglar_FX_C::OnActualStatChange()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "OnActualStatChange");
...
void ACCPM_M_CatBurglar_FX_C::OnEnterVehicle(const TScriptInterface<class IFortVehicleInterface>& VehicleEntered)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "OnEnterVehicle");

	Params::CCPM_M_CatBurglar_FX_C_OnEnterVehicle Parms{};
...
void ACCPM_M_CatBurglar_FX_C::OnNewWeapons(const TArray<class UFortItem*>& WeaponsAsItems)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "OnNewWeapons");

	Params::CCPM_M_CatBurglar_FX_C_OnNewWeapons Parms{};
...
void ACCPM_M_CatBurglar_FX_C::OnPawnAndPartChanged()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "OnPawnAndPartChanged");
...
void ACCPM_M_CatBurglar_FX_C::OnStatChanged_E87C356F471121E9AB7F4290E8B54301(class FName StatName, int32 StatValue)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "OnStatChanged_E87C356F471121E9AB7F4290E8B54301");

	Params::CCPM_M_CatBurglar_FX_C_OnStatChanged_E87C356F471121E9AB7F4290E8B54301 Parms{};
...
void ACCPM_M_CatBurglar_FX_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "UserConstructionScript");
...
void ACCPM_M_CatBurglar_FX_C::Death_Check()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "Death Check");
...
void ACCPM_M_CatBurglar_FX_C::GetAssociatedAthenaController(class AFortPlayerControllerAthena** AsFort_Player_Controller_Athena)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "GetAssociatedAthenaController");

	Params::CCPM_M_CatBurglar_FX_C_GetAssociatedAthenaController Parms{};
...
void ACCPM_M_CatBurglar_FX_C::ApplyOverrideToItems(TArray<class UFortItem*>& Array)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "ApplyOverrideToItems");

	Params::CCPM_M_CatBurglar_FX_C_ApplyOverrideToItems Parms{};
...
void ACCPM_M_CatBurglar_FX_C::ApplyLevelParam(int32 Level)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CCPM_M_CatBurglar_FX_C", "ApplyLevelParam");

	Params::CCPM_M_CatBurglar_FX_C_ApplyLevelParam Parms{};
