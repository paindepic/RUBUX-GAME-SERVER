...
static_assert(offsetof(MiniCraftingIngredientList_C_ExecuteUbergraph_MiniCraftingIngredientList, CallFunc_AddChildToWrapBox_ReturnValue) == 0x000020, "Member 'MiniCraftingIngredientList_C_ExecuteUbergraph_MiniCraftingIngredientList::CallFunc_AddChildToWrapBox_ReturnValue' has a wrong offset!");
