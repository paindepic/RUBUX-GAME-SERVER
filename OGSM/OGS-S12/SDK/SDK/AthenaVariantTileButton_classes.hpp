...
static_assert(sizeof(UAthenaVariantTileButton_C) == 0x000BF0, "Wrong size on UAthenaVariantTileButton_C");
static_assert(offsetof(UAthenaVariantTileButton_C, UberGraphFrame) == 0x000BE8, "Member 'UAthenaVariantTileButton_C::UberGraphFrame' has a wrong offset!");
