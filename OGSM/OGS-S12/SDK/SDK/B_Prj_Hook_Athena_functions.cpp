...
void AB_Prj_Hook_Athena_C::OnEnterWaterEvent_Event_0(class AFortWaterBodyActor* WaterBody, class UFortWaterInteractionComponent* WaterInteractionComponent_0, bool bIsFirstBody)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_Prj_Hook_Athena_C", "OnEnterWaterEvent_Event_0");

	Params::B_Prj_Hook_Athena_C_OnEnterWaterEvent_Event_0 Parms{};
