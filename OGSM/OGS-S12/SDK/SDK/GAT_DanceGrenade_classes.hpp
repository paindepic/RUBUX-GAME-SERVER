...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GAT_DanceGrenade_C;                 // 0x0A48(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UGAT_DanceGrenade_C) == 0x000A58, "Wrong size on UGAT_DanceGrenade_C");
static_assert(offsetof(UGAT_DanceGrenade_C, UberGraphFrame_GAT_DanceGrenade_C) == 0x000A48, "Member 'UGAT_DanceGrenade_C::UberGraphFrame_GAT_DanceGrenade_C' has a wrong offset!");
static_assert(offsetof(UGAT_DanceGrenade_C, PlayerPawn) == 0x000A50, "Member 'UGAT_DanceGrenade_C::PlayerPawn' has a wrong offset!");
