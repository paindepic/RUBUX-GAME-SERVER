...
public:
	...
	class UCommonTextBlock*                       Text_Content;                                      // 0x0350(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTextBlock*                       Text_Progress;                                     // 0x0358(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(ULoadingSubGameContentModal_C) == 0x000360, "Wrong size on ULoadingSubGameContentModal_C");
...
static_assert(offsetof(ULoadingSubGameContentModal_C, Text_Content) == 0x000350, "Member 'ULoadingSubGameContentModal_C::Text_Content' has a wrong offset!");
static_assert(offsetof(ULoadingSubGameContentModal_C, Text_Progress) == 0x000358, "Member 'ULoadingSubGameContentModal_C::Text_Progress' has a wrong offset!");
