...
// Parameters:
// TArray<class USceneComponent*>          Scene_Components                                       (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// TMap<class USceneComponent*, ECollisionEnabled>Collision_Overrides                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, ContainsInstancedReference)
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<class USceneComponent*>          Array                                                  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
