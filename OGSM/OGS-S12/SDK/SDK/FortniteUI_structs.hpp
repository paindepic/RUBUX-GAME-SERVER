...
public:
	...
	bool                                          bIsCarryingHeldObject;                             // 0x0016(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsZiplining;                                      // 0x0017(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsCreativeFlying;                                 // 0x0018(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortHUDState) == 0x000001, "Wrong alignment on FFortHUDState");
static_assert(sizeof(FFortHUDState) == 0x000019, "Wrong size on FFortHUDState");
...
static_assert(offsetof(FFortHUDState, bIsCarryingHeldObject) == 0x000016, "Member 'FFortHUDState::bIsCarryingHeldObject' has a wrong offset!");
static_assert(offsetof(FFortHUDState, bIsZiplining) == 0x000017, "Member 'FFortHUDState::bIsZiplining' has a wrong offset!");
static_assert(offsetof(FFortHUDState, bIsCreativeFlying) == 0x000018, "Member 'FFortHUDState::bIsCreativeFlying' has a wrong offset!");
...
public:
	...
	struct FDataTableRowHandle                    ActionWidget_DataTableRow;                         // 0x0068(0x0010)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           KeybindWidget_NameArray;                           // 0x0078(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           KeybindWidget_GamepadNameArray;                    // 0x0088(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          ForceSingleInputKeybind;                           // 0x0098(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_99[0x7];                                       // 0x0099(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FFortAthenaTutorialHighlightInfo> HighlightInfo;                                     // 0x00A0(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          DisplayNextButton;                                 // 0x00B0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DisplayTextPromptTarget;                           // 0x00B1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFortAthenaTutorialScreenExtraWidget          ExtraWidget;                                       // 0x00B2(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortAthenaTutorialScreenInfo) == 0x0000B8, "Wrong size on FFortAthenaTutorialScreenInfo");
...
static_assert(offsetof(FFortAthenaTutorialScreenInfo, ActionWidget_DataTableRow) == 0x000068, "Member 'FFortAthenaTutorialScreenInfo::ActionWidget_DataTableRow' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, KeybindWidget_NameArray) == 0x000078, "Member 'FFortAthenaTutorialScreenInfo::KeybindWidget_NameArray' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, KeybindWidget_GamepadNameArray) == 0x000088, "Member 'FFortAthenaTutorialScreenInfo::KeybindWidget_GamepadNameArray' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, ForceSingleInputKeybind) == 0x000098, "Member 'FFortAthenaTutorialScreenInfo::ForceSingleInputKeybind' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, HighlightInfo) == 0x0000A0, "Member 'FFortAthenaTutorialScreenInfo::HighlightInfo' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, DisplayNextButton) == 0x0000B0, "Member 'FFortAthenaTutorialScreenInfo::DisplayNextButton' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, DisplayTextPromptTarget) == 0x0000B1, "Member 'FFortAthenaTutorialScreenInfo::DisplayTextPromptTarget' has a wrong offset!");
static_assert(offsetof(FFortAthenaTutorialScreenInfo, ExtraWidget) == 0x0000B2, "Member 'FFortAthenaTutorialScreenInfo::ExtraWidget' has a wrong offset!");
...
static_assert(offsetof(FFortSimpleWidgetAnimation, World) == 0x000050, "Member 'FFortSimpleWidgetAnimation::World' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFortAthenaTutorialScreenInfo          StepScreenInfo;                                    // 0x0008(0x00B8)(Edit, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortAthenaTutorialStandaloneStepInfo) == 0x0000C0, "Wrong size on FFortAthenaTutorialStandaloneStepInfo");
...
public:
	...
	class UFortMobileHUDContextModel*             HUDContextModel;                                   // 0x0020(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortMobileHUDContextLayout) == 0x000008, "Wrong alignment on FFortMobileHUDContextLayout");
static_assert(sizeof(FFortMobileHUDContextLayout) == 0x000030, "Wrong size on FFortMobileHUDContextLayout");
static_assert(offsetof(FFortMobileHUDContextLayout, HUDContextModel) == 0x000020, "Member 'FFortMobileHUDContextLayout::HUDContextModel' has a wrong offset!");
...
public:
	...
	bool                                          bLinkAcrossLayoutContexts;                         // 0x0010(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(FHUDWidgetRegistryEntry, bLinkAcrossLayoutContexts) == 0x000010, "Member 'FHUDWidgetRegistryEntry::bLinkAcrossLayoutContexts' has a wrong offset!");
static_assert(offsetof(FHUDWidgetRegistryEntry, MaximumAmountOfInstances) == 0x000014, "Member 'FHUDWidgetRegistryEntry::MaximumAmountOfInstances' has a wrong offset!");
