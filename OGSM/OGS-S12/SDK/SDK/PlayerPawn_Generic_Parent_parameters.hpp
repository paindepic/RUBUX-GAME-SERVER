...
static_assert(alignof(PlayerPawn_Generic_Parent_C_OnOverlapWaterVolume__DelegateSignature) == 0x000008, "Wrong alignment on PlayerPawn_Generic_Parent_C_OnOverlapWaterVolume__DelegateSignature");
static_assert(sizeof(PlayerPawn_Generic_Parent_C_OnOverlapWaterVolume__DelegateSignature) == 0x000018, "Wrong size on PlayerPawn_Generic_Parent_C_OnOverlapWaterVolume__DelegateSignature");
static_assert(offsetof(PlayerPawn_Generic_Parent_C_OnOverlapWaterVolume__DelegateSignature, bIsInWater) == 0x000000, "Member 'PlayerPawn_Generic_Parent_C_OnOverlapWaterVolume__DelegateSignature::bIsInWater' has a wrong offset!");
static_assert(offsetof(PlayerPawn_Generic_Parent_C_OnOverlapWaterVolume__DelegateSignature, Pawn) == 0x000008, "Member 'PlayerPawn_Generic_Parent_C_OnOverlapWaterVolume__DelegateSignature::Pawn' has a wrong offset!");
static_assert(offsetof(PlayerPawn_Generic_Parent_C_OnOverlapWaterVolume__DelegateSignature, Water) == 0x000010, "Member 'PlayerPawn_Generic_Parent_C_OnOverlapWaterVolume__DelegateSignature::Water' has a wrong offset!");
