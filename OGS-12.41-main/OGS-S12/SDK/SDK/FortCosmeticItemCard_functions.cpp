...
void UFortCosmeticItemCard_C::OnCardTypeChanged(bool bUseNewItemCard)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortCosmeticItemCard_C", "OnCardTypeChanged");

	Params::FortCosmeticItemCard_C_OnCardTypeChanged Parms{};
...
void UFortCosmeticItemCard_C::OnUpdateItemCardIcon(const TSoftObjectPtr<class UTexture2D>& Icon)
{
	static class UFunction* Func = nullptr;
