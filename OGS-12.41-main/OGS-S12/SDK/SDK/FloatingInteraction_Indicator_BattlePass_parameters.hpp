...
struct FloatingInteraction_Indicator_BattlePass_C_SetCATextFX final
{
public:
	class FText                                   CallFunc_GetText_ReturnValue;                      // 0x0000(0x0018)()
};
static_assert(alignof(FloatingInteraction_Indicator_BattlePass_C_SetCATextFX) == 0x000008, "Wrong alignment on FloatingInteraction_Indicator_BattlePass_C_SetCATextFX");
static_assert(sizeof(FloatingInteraction_Indicator_BattlePass_C_SetCATextFX) == 0x000018, "Wrong size on FloatingInteraction_Indicator_BattlePass_C_SetCATextFX");
static_assert(offsetof(FloatingInteraction_Indicator_BattlePass_C_SetCATextFX, CallFunc_GetText_ReturnValue) == 0x000000, "Member 'FloatingInteraction_Indicator_BattlePass_C_SetCATextFX::CallFunc_GetText_ReturnValue' has a wrong offset!");
