...
static_assert(offsetof(ABP_VictoryDrone_C, Scene) == 0x000288, "Member 'ABP_VictoryDrone_C::Scene' has a wrong offset!");
static_assert(offsetof(ABP_VictoryDrone_C, StaticMesh) == 0x000290, "Member 'ABP_VictoryDrone_C::StaticMesh' has a wrong offset!");
