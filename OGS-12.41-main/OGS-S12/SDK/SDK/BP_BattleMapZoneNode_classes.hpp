...
static_assert(sizeof(ABP_BattleMapZoneNode_C) == 0x000358, "Wrong size on ABP_BattleMapZoneNode_C");
static_assert(offsetof(ABP_BattleMapZoneNode_C, StaticMesh_Inverted) == 0x000350, "Member 'ABP_BattleMapZoneNode_C::StaticMesh_Inverted' has a wrong offset!");
