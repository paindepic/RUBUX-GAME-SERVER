...
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_IsMobileGame_ReturnValue) == 0x000004, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_BooleanOR_ReturnValue) == 0x000015, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
