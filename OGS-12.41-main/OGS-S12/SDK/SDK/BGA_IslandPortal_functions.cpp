...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure, Const)
// Parameters:
// bool                                    bCheckCanInteract                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                                    bCanModify                                             (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void ABGA_IslandPortal_C::CanModifyPortal(bool bCheckCanInteract, bool* bCanModify) const
{
	static class UFunction* Func = nullptr;
	...
	Parms.bCheckCanInteract = bCheckCanInteract;
