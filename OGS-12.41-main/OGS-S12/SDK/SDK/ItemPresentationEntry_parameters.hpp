...
static_assert(sizeof(ItemPresentationEntry_C_HandleSelectedAnim) == 0x000008, "Wrong size on ItemPresentationEntry_C_HandleSelectedAnim");
static_assert(offsetof(ItemPresentationEntry_C_HandleSelectedAnim, CallFunc_PlayAnimation_ReturnValue) == 0x000000, "Member 'ItemPresentationEntry_C_HandleSelectedAnim::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(ItemPresentationEntry_C_HandelDeselectedAnim) == 0x000008, "Wrong size on ItemPresentationEntry_C_HandelDeselectedAnim");
static_assert(offsetof(ItemPresentationEntry_C_HandelDeselectedAnim, CallFunc_PlayAnimation_ReturnValue) == 0x000000, "Member 'ItemPresentationEntry_C_HandelDeselectedAnim::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
