...
void UAmbientAudioStatics::AddAmbientEntry(class UObject* WorldContextObject, class FName AmbientName, const class UAmbientAudioDataAsset* Asset, int32 Priority)
{
