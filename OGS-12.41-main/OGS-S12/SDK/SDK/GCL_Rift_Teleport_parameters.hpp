...
static_assert(sizeof(GCL_Rift_Teleport_C_WhileActive) == 0x000120, "Wrong size on GCL_Rift_Teleport_C_WhileActive");
...
static_assert(offsetof(GCL_Rift_Teleport_C_WhileActive, CallFunc_GetVehicleUInterface_ReturnValue) == 0x0000E8, "Member 'GCL_Rift_Teleport_C_WhileActive::CallFunc_GetVehicleUInterface_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCL_Rift_Teleport_C_WhileActive, CallFunc_GetSkeletalMeshComponent_ReturnValue) == 0x0000F8, "Member 'GCL_Rift_Teleport_C_WhileActive::CallFunc_GetSkeletalMeshComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCL_Rift_Teleport_C_WhileActive, CallFunc_Conv_InterfaceToObject_ReturnValue) == 0x000100, "Member 'GCL_Rift_Teleport_C_WhileActive::CallFunc_Conv_InterfaceToObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCL_Rift_Teleport_C_WhileActive, CallFunc_SpawnEmitterAttached_ReturnValue) == 0x000108, "Member 'GCL_Rift_Teleport_C_WhileActive::CallFunc_SpawnEmitterAttached_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCL_Rift_Teleport_C_WhileActive, CallFunc_IsValid_ReturnValue) == 0x000110, "Member 'GCL_Rift_Teleport_C_WhileActive::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCL_Rift_Teleport_C_WhileActive, CallFunc_IsDrivingVehicle_ReturnValue) == 0x000111, "Member 'GCL_Rift_Teleport_C_WhileActive::CallFunc_IsDrivingVehicle_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCL_Rift_Teleport_C_WhileActive, CallFunc_SpawnEmitterAttached_ReturnValue_1) == 0x000118, "Member 'GCL_Rift_Teleport_C_WhileActive::CallFunc_SpawnEmitterAttached_ReturnValue_1' has a wrong offset!");
