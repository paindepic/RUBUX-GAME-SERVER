...
public:
	...
	bool                                          CallFunc_IsSplitScreen_ReturnValue;                // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(UnderwaterAudioComponent_C_ExecuteUbergraph_UnderwaterAudioComponent) == 0x000038, "Wrong size on UnderwaterAudioComponent_C_ExecuteUbergraph_UnderwaterAudioComponent");
...
static_assert(offsetof(UnderwaterAudioComponent_C_ExecuteUbergraph_UnderwaterAudioComponent, CallFunc_IsSplitScreen_ReturnValue) == 0x000004, "Member 'UnderwaterAudioComponent_C_ExecuteUbergraph_UnderwaterAudioComponent::CallFunc_IsSplitScreen_ReturnValue' has a wrong offset!");
