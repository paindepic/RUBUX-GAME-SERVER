...
static_assert(alignof(UGCN_Snowman_Equiped_C) == 0x000008, "Wrong alignment on UGCN_Snowman_Equiped_C");
static_assert(sizeof(UGCN_Snowman_Equiped_C) == 0x0001B0, "Wrong size on UGCN_Snowman_Equiped_C");
