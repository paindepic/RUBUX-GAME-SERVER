...
static_assert(offsetof(GrapplingHookGun_AnimBP_C_AnimGraph, AnimGraph_0) == 0x000000, "Member 'GrapplingHookGun_AnimBP_C_AnimGraph::AnimGraph_0' has a wrong offset!");
