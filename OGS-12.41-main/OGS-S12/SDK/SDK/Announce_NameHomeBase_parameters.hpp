...
static_assert(offsetof(Announce_NameHomeBase_C_ExecuteUbergraph_Announce_NameHomeBase, K2Node_Event_SentenceIdx_1) == 0x000010, "Member 'Announce_NameHomeBase_C_ExecuteUbergraph_Announce_NameHomeBase::K2Node_Event_SentenceIdx_1' has a wrong offset!");
...
static_assert(offsetof(Announce_NameHomeBase_C_ExecuteUbergraph_Announce_NameHomeBase, K2Node_SwitchInteger_CmpSuccess_1) == 0x000030, "Member 'Announce_NameHomeBase_C_ExecuteUbergraph_Announce_NameHomeBase::K2Node_SwitchInteger_CmpSuccess_1' has a wrong offset!");
