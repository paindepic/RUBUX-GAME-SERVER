...
void UAthenaSpectateMatchModal_C::BndEvt__CloseButton_130_K2Node_ComponentBoundEvent_3_CommonButtonClicked__DelegateSignature(class UCommonButton* Button)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaSpectateMatchModal_C", "BndEvt__CloseButton_130_K2Node_ComponentBoundEvent_3_CommonButtonClicked__DelegateSignature");

	Params::AthenaSpectateMatchModal_C_BndEvt__CloseButton_130_K2Node_ComponentBoundEvent_3_CommonButtonClicked__DelegateSignature Parms{};
