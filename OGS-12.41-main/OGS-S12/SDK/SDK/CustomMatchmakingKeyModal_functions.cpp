...
void UCustomMatchmakingKeyModal_C::BndEvt__CloseButton_120_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature(class UCommonButton* Button)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CustomMatchmakingKeyModal_C", "BndEvt__CloseButton_120_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");

	Params::CustomMatchmakingKeyModal_C_BndEvt__CloseButton_120_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature Parms{};
