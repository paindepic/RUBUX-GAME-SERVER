...
static_assert(offsetof(GA_Ninja_SwordHitsHeal_C_K2_ActivateAbilityFromEvent, EventData_0) == 0x000000, "Member 'GA_Ninja_SwordHitsHeal_C_K2_ActivateAbilityFromEvent::EventData_0' has a wrong offset!");
