...
static_assert(sizeof(ItemPreviewPedestal_C_ExecuteUbergraph_ItemPreviewPedestal) == 0x000004, "Wrong size on ItemPreviewPedestal_C_ExecuteUbergraph_ItemPreviewPedestal");
