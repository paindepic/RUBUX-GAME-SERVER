...
void AB_BGA_Athena_SilverBlazer_V2_C::Set_RippleFX_Param(const struct FVector& HitWaveMinusLoc, const float HitWaveMinusSizeMultiplierOuterRing, const float HitWaveMinusSizeMultiplierInnerRing, const float HitWaveMinusDurationNew, float HitGridBrightness)
{
	static class UFunction* Func = nullptr;
	...
	Parms.HitWaveMinusLoc = std::move(HitWaveMinusLoc);
