...
static_assert(alignof(RigVM_Execute) == 0x000001, "Wrong alignment on RigVM_Execute");
static_assert(sizeof(RigVM_Execute) == 0x000001, "Wrong size on RigVM_Execute");
static_assert(offsetof(RigVM_Execute, ReturnValue) == 0x000000, "Member 'RigVM_Execute::ReturnValue' has a wrong offset!");
