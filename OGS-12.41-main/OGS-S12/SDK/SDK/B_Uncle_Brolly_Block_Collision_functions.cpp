...
#include "B_Uncle_Brolly_Block_Collision_parameters.hpp"
...
void AB_Uncle_Brolly_Block_Collision_C::ExecuteUbergraph_B_Uncle_Brolly_Block_Collision(int32 EntryPoint)
{
	...
	Params::B_Uncle_Brolly_Block_Collision_C_ExecuteUbergraph_B_Uncle_Brolly_Block_Collision Parms{};
...
void AB_Uncle_Brolly_Block_Collision_C::RemovalChecks(class AFortPlayerPawn* PlayerPawn_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Uncle_Brolly_Block_Collision_C_RemovalChecks Parms{};
...
void AB_Uncle_Brolly_Block_Collision_C::CustomEvent_0(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, const struct FVector& HitLocation, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum)
{
	...
	Params::B_Uncle_Brolly_Block_Collision_C_CustomEvent_0 Parms{};
...
void AB_Uncle_Brolly_Block_Collision_C::OnDeathServer(float Damage, const struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, const struct FHitResult& HitInfo, class AController* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Uncle_Brolly_Block_Collision_C_OnDeathServer Parms{};
...
void AB_Uncle_Brolly_Block_Collision_C::OnDamageServer(float Damage, const struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, const struct FHitResult& HitInfo, class AController* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Uncle_Brolly_Block_Collision_C_OnDamageServer Parms{};
...
void AB_Uncle_Brolly_Block_Collision_C::GameplayCue_Damage(EGameplayCueEvent EventType, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Uncle_Brolly_Block_Collision_C_GameplayCue_Damage Parms{};
...
void AB_Uncle_Brolly_Block_Collision_C::ExecuteBlockGameplayCue(float Damage, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext, class AActor* Instigator_0, const struct FHitResult& HitResult, bool* WasGalileoBun)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Uncle_Brolly_Block_Collision_C_ExecuteBlockGameplayCue Parms{};
...
void AB_Uncle_Brolly_Block_Collision_C::OnRep_CollisionEnabled()
{
	static class UFunction* Func = nullptr;
...
void AB_Uncle_Brolly_Block_Collision_C::SendBlockedDamageEvent(float Damage, class AActor* DamageCauser)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Uncle_Brolly_Block_Collision_C_SendBlockedDamageEvent Parms{};
...
void AB_Uncle_Brolly_Block_Collision_C::BlockedUncleImpulse(const struct FHitResult& HitInfo, class ACharacter* Instigator_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Uncle_Brolly_Block_Collision_C_BlockedUncleImpulse Parms{};
...
void AB_Uncle_Brolly_Block_Collision_C::ToggleProtoFX(bool Visible)
{
	...
	Params::B_Uncle_Brolly_Block_Collision_C_ToggleProtoFX Parms{};
...
void AB_Uncle_Brolly_Block_Collision_C::SetDamageThresholdVisuals()
{
	static class UFunction* Func = nullptr;
...
void AB_Uncle_Brolly_Block_Collision_C::PlayHitReactMontage()
{
	static class UFunction* Func = nullptr;
